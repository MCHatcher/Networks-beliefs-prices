...
title('Price deviation'), xlabel('Time'), axis([-inf,40,0,3]), hold on,
...
title('Price deviation'), xlabel('Time'), axis([-inf,40,0,5]), hold on,
subplot(2,3,4), plot(Periods, gmean, '--k'),  hold on,
title('Average type'), xlabel('Time'), axis([-inf,40,0,inf])